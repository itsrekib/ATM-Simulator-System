...
public class Signup2 extends JFrame implements ActionListener{
   ...
   public void actionPerformed(ActionEvent ae) {
    ...
    // Map human-readable income ranges to numeric values
    String incomeValue = null;
    switch (income) {
        case "Null":
            incomeValue = "0"; // No income
            break;
        case "<1,50,000":
            incomeValue = "150000";
            break;
        ...
        case "Above 10,00,000":
            incomeValue = "1000001"; // Arbitrary value for above 10,00,000
            break;
    }
    ...
    try {
        if (t2.getText().isEmpty()) {
            ...
            String q1 = String.format(
                "INSERT INTO signup2 (formno, religion, category, income, education, occupation, pan, aadhar, scitizen, eaccount) " +
                "VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')",
                formno, religion, category, incomeValue, education, occupation, pan, aadhar, scitizen, eaccount
            );
